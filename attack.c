...
unsigned short in_cksum (unsigned short *buf, int length){ //details page 324
...
void send_raw_ip_packet(struct ipheader* ip){ // details page 309
...
int main(int argc, char **argv){
	...
	icmp->icmp_code = 1; //communication with destination administratively prohibited
	icmp->icmp_chksum = 0;
